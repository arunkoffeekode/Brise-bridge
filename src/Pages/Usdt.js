            ...
            <div className="col-md-12 col-lg-7 col-sm-12 col-xl-7">
              <div className="checkout-form-centre">
                <div className="checkout-login-step">
                  <div className="head">
                    <h2>USDT Bridge</h2>
                    <Link to='/usdtTx' className="button2">
                        ...
                        <div>
                          <div className="round">
                            <div className="box">
                              ...
                              ></input>
                              <div className="icon">
                                <img src={network[0].usdtLogo} alt="" />
                                {/* <img src={network[0].logo} alt="" /> */}
                                {/* <span>{network[0].usdtsymbol}</span> */}
                                <div class="btn-group">
                        ...
                        <div>
                          <div className="round">
                            <div className="box">
                              ...
                              ></input>
                              <div className="icon">
                                <img src={network[1].usdtLogo} alt="" />
                                {/* <span>{network[1].usdtsymbol}</span> */}
                                <div class="btn-group">
                                  <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Right-aligned menu
                                  </button>
